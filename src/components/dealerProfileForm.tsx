      ...
      <div className="bg-blue-100 place-self-center p-6 rounded-lg shadow-lg justify-center max-w-xl">
        <form>
          <div className="mb-8 flex flex-col">
            ...
            <input className="px-4 py-3 rounded" placeholder="555-555-5555" />
            <label>Dealer License Number(including type initials)</label>
            <input className="px-4 py-3 rounded" placeholder="DA0000" />
